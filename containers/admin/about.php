...
<div class="w3-container ">
    <header class="w3-container w3-center w3-blue" >
            <h3>Thank You For Choosing Jamilsoft</h3>
    </header>
        ...
        <div class="flex-containerx w3-sand">
            <div class="w3-center">
                ...
                <h1>Jamilsoft</h1>
                <h3>SaaS Management Framework for Everyone</h3>
                <a href="https://paystack.com/pay/jamilsofte" class="w3-button w3-blue w3-round-xlarge">Donate</a>
            </div>
        </div>
